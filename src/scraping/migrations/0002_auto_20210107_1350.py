# Generated by Django 3.0.11 on 2021-01-07 03:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(blank=True, max_length=50, unique=True, verbose_name='Короткое название')),
            ],
            options={
        ...
        migrations.AlterField(
            model_name='city',
            name='slug',
            field=models.CharField(blank=True, max_length=50, unique=True, verbose_name='Короткое название'),
        ),
    ]
